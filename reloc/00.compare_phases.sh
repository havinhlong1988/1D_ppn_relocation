...
gawk 'NR>=2&&$16 == 1 {print $13, $12}' output_data | psxy -R -JX -B -G0/0/0 -Sc0.1 -K -O -V >> $out.ps 
#gawk '{print $3, $2}' 00_Pn | psxy -R -JX -B -G0/200/0 -Sc0.1 -K -O -V >> $out.ps
gawk 'NR>=2&&$16 == 3 {print $13, $12}' output_data | psxy -R -JX -B -G0/200/0 -Sc0.1 -K -O -V >> $out.ps 
